...
private val sky = mapOf(
    ...
    "PARTLY_CLOUDY_DAY" to Sky("多云（白天）", R.drawable.ic_cloudy, R.drawable.bg_cloudy),
    "CLEAR_DAY" to Sky("晴（白天）", R.drawable.ic_clear_day, R.drawable.bg_clear_day),
    "CLEAR_NIGHT" to Sky("晴（夜间）", R.drawable.ic_clear_night, R.drawable.bg_clear_night),
    "PARTLY_CLOUDY_NIGHT" to Sky("多云（夜间）", R.drawable.ic_cloudy, R.drawable.bg_cloudy),
    "SAND" to Sky("沙尘", R.drawable.ic_fog, R.drawable.bg_fog),
)

//根据天气代码获取对应的Sky对象，skycon只包含date 和 value(例如"LIGHT_RAIN")
